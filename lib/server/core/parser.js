"use strict";
var Brick, Page, Parser, Q, cheerio, config, fs, root;
...
module.exports = Parser = (function() {
  var _$, _generateCode, _load, _pageInfos, _parseBricks, _sPath, _sRawContent, _sResultingContent, _sUrl;
  ...
  Parser.prototype.display = function(fNext) {
    return Q.fcall(_load).then(_parseBricks).then(_pageInfos).then(_generateCode).fail(function(oError) {
      return fNext(oError);
    }).done(function() {
